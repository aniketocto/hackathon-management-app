...
import { oldHackathon } from "db/crud";
...
const OldEvents = () => {
  ...
  useEffect(() => {
    const fetchHackathons = async () => {
      try {
        const OldHackathons = await oldHackathon();
        setHackathons(OldHackathons);
      } catch (error) {
          ...
          >
            ...
            <div className="flex justify-between items-center">
              ...
              <button
                ...
                onClick={() => navigateToHackathonDetails(hackathon.id)} // Replace with your routing/navigation logic
              >
                Learn More
              </button>
            </div>
